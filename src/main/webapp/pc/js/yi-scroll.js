...
$.fn.yi_scroll = function(options)
{
	var scroll_config={
		...
		"barColor" : "rgba(101,102,102,1)",
		"barMDColor" : "rgba(103,102,102,0.5)",
		"boxColor" : "rgba(104,102,102,0.3)",
		"isBox":false,
		"isBar":false
	}
	...
	return this.each(function(){
		...
		var jqScrollBox = $("<div style='position:absolute;opacity:"+1+";width:"+opts.boxWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;bottom:"+opts.barOffBottom+"px;border-radius: 5px;background: "+color.box+";'></div>");
