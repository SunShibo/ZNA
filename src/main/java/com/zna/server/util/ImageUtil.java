...
public class ImageUtil {
    public static String getPCpicture(MultipartFile file, int width, int height)throws IOException {
    ...
    public static String getPhonepicture(MultipartFile file, int width,int height)throws IOException{
