package com.zna.server.util.redisUtils;
...
public class RedissonHandler {
    ...
    private final String ip = "60.205.226.180";//"60.205.226.180";//"wisewin-tech.com";

    private final String password ="denglu328325";//"denglu328325";//"sunshibo1!";
