...
public class ContactWayService {
     ...
     */
   public void   updateContactWay(String mobile,String faxNO,String email,String pictureOne,String pictureTwo,String pictureThree,Integer createUserId,Integer updateUserId) {
