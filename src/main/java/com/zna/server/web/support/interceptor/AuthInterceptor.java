package com.zna.server.web.support.interceptor;
...
//    private SystemService systemService ;
    ...
    // 不需要过滤的URL
    public static final Set<String> unCheckList = Sets.newHashSet("/aboutUs/getAboutUs" , "/admin/getRoleList" , "/admin/getPermissionsMenu" , "/admin/getAdminById","/admin/grantAuthority" ,"/admin/changePassword" ,"/admin/getAllRoleMenu" ,"/admin/adminLogin" ,"/banner/selectBanner" ,"/contactWay/getContactWay" ,"/cooperativeClient/getCooperativeClient" ,"/cooperativeClient/getCooperativeClientS" ,"/fromPicture/getFromPicture" ,"/history/getHistory" ,"/index/getIndex" ,"/index/selectIndex" ,"/officeContact/getOfficeContact" ,"/personnelRecruitment/getPersonnelRecruitment" ,"/project/getProjectDetails" ,"/project/getProject" ,"/recentNews/selectRecentNewsDetails" ,"/recentNews/selectRecentNews" ,"/recruitingJob/getRecruitingJob" ,"/team/getTeamBOById" ,"/team/getTeamBO","/service/getservice","/aboutBanner/selectAboutBanner" ) ;
