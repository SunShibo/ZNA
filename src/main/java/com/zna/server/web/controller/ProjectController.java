...
public class ProjectController extends BaseCotroller {
    ...
    public void updateProject(Integer id,String projectTypeName, String projectTypeNameEnglish, String title, String titleEnglish, String type,Integer sort, String pictureUrl,String pictureUrlPc,String thumbnail,String thumbnailPc, String site, String siteEnglish, String floorSpace,String floorSpaceEnglish,String coveredArea,String coveredAreaEnglish,String client,String clientEnglish,String context, String contextEnglish,String property,String propertyEnglish, HttpServletRequest request, HttpServletResponse response){
        try{
            log.info(request.getRequestURI());
            log.info("param:{}", JsonUtils.getJsonString4JavaPOJO(request.getParameterMap()));
            //获取管理员对象
            ...
            projectService.updateProject(id,projectTypeName,projectTypeNameEnglish,title,titleEnglish,type,sort,pictureUrl,pictureUrlPc,thumbnail,thumbnailPc,site,siteEnglish,floorSpace,floorSpaceEnglish,coveredArea,coveredAreaEnglish,client,clientEnglish,context,contextEnglish,property,propertyEnglish,loginAdmin.getId());
    ...
    @RequestMapping("/getProjectIdList")
    public void getProjectIdList( HttpServletRequest request, HttpServletResponse response){
        try{
            log.info(request.getRequestURI());
            log.info("param:{}", JsonUtils.getJsonString4JavaPOJO(request.getParameterMap()));
            //获取管理员对象
            ...
            List<ProjectTypeNameBO> projectTypeNameBOS = projectService.getProjectIdList();
            String result = JsonUtils.getJsonString4JavaPOJO(ResultDTOBuilder.success(projectTypeNameBOS));
            super.safeJsonPrint(response, result);
            log.info("result{}",result);
            return ;
